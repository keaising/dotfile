 ...
 * @param {number} heightRatio - Height ratio (default 1.0 for full available height)
 * @returns {Object} Object containing newW, newH, newX, newY
 */
function calculateWindowBounds(screen, widthRatio = 0.8, heightRatio = 1.0) {
  const screenFrame = screen.frame;
